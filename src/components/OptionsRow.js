    ...
    options: [
      {
        ...
        label: (
          <>
            {" "}
            <span className="tag temp">tas</span>
      ...
      },
      {
        ...
        label: (
          <>
            <span className="tag temp">tasmax</span>{" "}
            <span className="description">
              {" "}
      ...
      },
      {
        ...
        label: (
          <>
            <span className="tag temp">tasmin</span>{" "}
            <span className="description">
              {" "}
      ...
      },
      {
        ...
        label: (
          <>
            {" "}
            <span className="tag temp">tas99</span>{" "}
            <span className="description">
              {" "}
              99th Percentile of Daily Mean Near-Surface Air Temperatures
            </span>{" "}
          </>
        ),
      },
      {
        ...
        label: (
          <>
            {" "}
            <span className="tag temp">tas01</span>{" "}
            <span className="description">
              {" "}
              1st Percentile of Daily Mean Near-Surface Air Temperatures
            </span>{" "}
          </>
        ),
      },
    ...
    options: [
      {
        ...
        label: (
          <>
            {" "}
            <span className="tag precip">pr</span>{" "}
            <span className="description"> Daily precipitation rate</span>{" "}
          </>
        ),
      },
      {
        ...
        label: (
          <>
            {" "}
            <span className="tag precip">prc</span>{" "}
            <span className="description">
              {" "}
              Daily rate of Convective Precipitation
            </span>{" "}
          </>
        ),
      },
      {
        ...
        label: (
          <>
            {" "}
            <span className="tag precip">prsn</span>{" "}
            <span className="description">
              {" "}
              Daily rate of precipitation falling as snow
            </span>{" "}
          </>
        ),
      },
      {
        ...
        label: (
          <>
            {" "}
            <span className="tag precip">fwd</span>{" "}
            <span className="description"> Proportion of wet days</span>
          </>
        ),
      },
      {
        ...
        label: (
          <>
            {" "}
            <span className="tag precip">r99ptot</span>{" "}
            <span className="description">r99ptot</span>{" "}
          </>
        ),
      },
    ],
    ...
    options: [
      {
        ...
        label: (
          <>
            {" "}
            <span className="tag wind">sfcWind</span>{" "}
            <span className="description"> Near-Surface Wind Speed</span>{" "}
          </>
        ),
      },
      {
        ...
        label: (
          <>
            {" "}
            <span className="tag wind">wsgsmax</span>{" "}
            <span className="description">
              {" "}
      ...
      },
      {
        ...
        label: (
          <>
            {" "}
            <span className="tag wind">uas</span>{" "}
            <span className="description"> Eastward Near-Surface Wind</span>{" "}
          </>
        ),
      },
      {
        ...
        label: (
          <>
            {" "}
            <span className="tag wind">vas</span>{" "}
            <span className="description"> Northward Near-Surface Wind</span>{" "}
          </>
        ),
      },
    ],
    ...
    options: [
      {
        ...
        label: (
          <>
            {" "}
            <span className="tag other">clt</span>{" "}
            <span className="description"> Total Cloud Fraction</span>{" "}
          </>
        ),
      },
      {
        ...
        label: (
          <>
            {" "}
            <span className="tag other">hurs</span>{" "}
            <span className="description"> Near-Surface Relative humidity</span>{" "}
          </>
        ),
      },
      {
        ...
        label: (
          <>
            {" "}
            <span className="tag other">psl</span>{" "}
            <span className="description"> Sea Level Pressure</span>{" "}
          </>
        ),
      },
      {
        ...
        label: (
          <>
            {" "}
            <span className="tag other">rss</span>{" "}
            <span className="description"> Net surface long wave flux</span>{" "}
          </>
        ),
      },
      {
        ...
        label: (
          <>
            {" "}
            <span className="tag other">rls</span>{" "}
            <span className="description"> Net surface long wave flux</span>{" "}
          </>
        ),
      },
