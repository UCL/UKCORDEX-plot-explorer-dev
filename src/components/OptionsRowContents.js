...
export const periodOptionsContents = [
  {
    ...
    options: [
      { tag: "present", value: "19890101-20081231", label: "Evaluation period: 1989-2008", title: "(1989-2008)" },
      { tag: "present", value: "19801201-20101130", label: "Reference period: 1981-2010", title: "(1981-2010)" },
    ]
  },
  {
    label: "Changes from 1980-2010 to fixed time periods",
    options: [
      { tag: "ref_fut", value: "20191201-20491130", label: "2020-2049", title: "(2020-2049 vs 1981-2010)" },
      { tag: "ref_fut", value: "20491201-20791130", label: "2050-2079", title: "(2050-2079 vs 1981-2010)" },
    ]
  },
  {
    label: "Changes from 1980-2010 to global warming levels",
    options: [
      { tag: "ref_gwl", value: "1.5", label: "1.5°C above pre-industrial", title: "after GMST increase of 1.5°C" },
      { tag: "ref_gwl", value: "2", label: "2°C above pre-industrial", title: "after GMST increase of 2°C" },
      { tag: "ref_gwl", value: "3", label: "3°C above pre-industrial", title: "after GMST increase of 3°C" },
    ]
  },
  {
    label: "Changes between global warming levels",
    options: [
      { tag: "gwl", value: "1-2", label: "from 1°C to 2°C above pre-industrial", title: "after GMST increase from 1°C to 2°C" }
    ]
  },
];
