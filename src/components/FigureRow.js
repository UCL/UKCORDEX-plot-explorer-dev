                ...
                <Row className="py-4">
                  <Figure>
                    <FigureImage
                      ...
                      src={`https://raw.githubusercontent.com/UCL/UKCORDEX-plot-explorer-data/main/images/${plotvar.value}/${plottype.value}_${plotvar.value}_${season.value}_${period.value}.png`}
                    />
                  </Figure>
                </Row>
              ))
